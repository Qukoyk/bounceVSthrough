...
answer2 = '3_errorlessStreaming_3'
...
# ファイルの保存先（ディレクトリ）
os.chdir('C:/Users/Shogo Sakata/Desktop/kyoku/shapingData/')
...
# レバー引き出し関数
def leverOut():
    board.digital[leverLeftMove].write(1)
...
while True:
    listen()
    if randList[randPosition] == 1 and randList[randPosition+1] == 1 and randPosition < 59:
